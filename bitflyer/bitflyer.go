...
func (c *APIClient) SendOrder(order *Order) (*ResponseSendChildOrder, error) {
	url := "me/sendchildorder"
	body, err := json.Marshal(order)
	if err != nil {
		return nil, err
	}
	resp, err := c.do("POST", url, nil, body)
	if err != nil {
		return nil, err
	}

	var res ResponseSendChildOrder
...
func (c *APIClient) ListOrder(query map[string]string) ([]Order, error) {
	url := "me/getchildorders"
	resp, err := c.do("GET", url, query, nil)
	if err != nil {
		return nil, err
	}
